...
- return true if block returns true for any value in array
- stop iterating through array if array returns true
- empty arrays return false

algorithm:
- return false if arr.empty?
- use each method on input array to iterate
- return true if yield(el) is true
- false at end
