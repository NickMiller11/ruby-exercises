...
# allows us to progress through a collection is part of that hidden implementation.

# There's also "External Iteration". This is iteration that takes place at
# the behest of the user. Ruby gives us the option to use this type of iteration
# with the Enumerator class. For this exercise, lets take a bit of a tour
# of the capabilities of Enumerator. While we do that, let's make something
# interesting with it.
...
# sure to read that section. Keep in mind that that section can be a bit dense;
# if you don't understand everything about it, that's ok.
