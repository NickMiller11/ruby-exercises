...
# A lone & applied to an object causes ruby to try to convert the object
# to a block. If that object is a proc, the conversion happens automagically,
# just as shown above. If the object is not a proc, then & attempts to call
# the #to_proc method on the object first. Used with symbols, e.g., &:to_s,
