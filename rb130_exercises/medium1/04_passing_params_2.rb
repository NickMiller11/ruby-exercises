...
# array as an argument. The method should yield the contents of the
# array to a block, which should assign your block variables in such
# a way that it ignores the first two elements, and groups all remaining
# elements as a raptors array.


birds_array = %w(raven finch hawk eagle)

def sample_method(birds_array)
  yield(birds_array)
end

sample_method(birds_array) do |_, _, *raptors|
