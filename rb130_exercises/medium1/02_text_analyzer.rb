# Fill out the rest of the Ruby code below so that print output like that
# shown in "Sample Output." You should read the text from a simple text file
# that you provide. (We also supply some example text below, but try the
