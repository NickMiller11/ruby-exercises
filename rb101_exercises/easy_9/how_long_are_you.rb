...
Rules:
- return an array that includes each word of the input string
- to each word should be appended a space and length of string

Algorithm:
- split the string into an array of words
- use map function to add the space and word length to each entry
=end
